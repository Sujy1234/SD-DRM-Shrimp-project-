...
- `Exposure assessment code`  
  Contains the R code used to estimate the dose of pathogenic *Vibrio parahaemolyticus* under three exposure scenarios: raw shrimp consumption, undercooked shrimp consumption, and hand-mediated cross-contamination. The simulated dose data generated in this folder are used as inputs in the shrimp SD-DRM analysis.
...
The exposure doses generated in the `Exposure assessment code` folder and the paired doxycycline pharmacodynamic parameters E<sub>max</sub> and EC<sub>50</sub> estimated in the `Final emax model-doxycycline` folder are used as inputs in the shrimp SD-DRM analysis.
